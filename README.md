...
in Microsoft Edge. Version 0.5.3 registers a versioned service worker, precaches the
...
Version 0.5.3 adds a pilot password gate and mandatory selection of the `data`
